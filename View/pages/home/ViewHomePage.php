...
<section id="welcome">
   <div class="welcome-section section-padding">
      ...
      <div class="row">
         <div id="welcome-slider" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
            <div class="owl-wrapper-outer">
               <div class="owl-wrapper" style="left: 0px; display: block; transition: all 1000ms ease; transform: translate3d(0px, 0px, 0px);">
                  <div class="owl-item" style="width: 33.33%;">
                     <div class="item col-xs-12">
                        <div class="welcome-post wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                  ...
                  <div class="owl-item" style="width: 33.33%;">
                     <div class="item col-xs-12">
                        <div class="welcome-post wow fadeIn animated animated" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
                           <div class="hex welcome-hex">
                              <span class="hex-icon">
                  ...
                  <div class="owl-item" style="width: 33.33%;">
                     <div class="item col-xs-12">
                        <div class="welcome-post wow fadeIn animated animated" data-wow-delay="0.3s" style="visibility: visible; animation-delay: 0.3s; animation-name: fadeIn;">
                           <div class="hex welcome-hex">
                              <span class="hex-icon">
      ...
      <!-- /.row -->
      <div class="best-deal">
         <img src="./images/home/foods-in-tray.jpg" alt="Foods Image" class="foods-img">
...
<section id="our-menus">
   <div class="our-menu section-padding">
      ...
      <div class="row">
         <div class="col-sm-6">
            <article class="menus-container wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
               <div class="featured-img">
                  <img src="./images/home/breakfast.jpg" alt="Breakfast Menus Image"> 
                  <a href="#./images/home/menus/breakfast-big.jpg" class="boxer img-link"></a>
               </div>
               <!-- /.featured-img -->
         ...
         <!-- /.col-sm-6 -->
         <div class="col-sm-6">
            <article class="menus-container wow fadeIn animated animated" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
               <div class="featured-img">
                  <img src="./images/home/lunch.jpg" alt="Lunch Menus Image">
                  <a href="#./images/home/menus/lunch-big.jpg" class="boxer img-link"></a>
               </div>
               <!-- /.featured-img -->
         ...
         <div class="col-sm-6">
            <article class="menus-container wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
               <div class="featured-img">
                  <img src="./images/home/desert.jpg" alt="Desert Menus Image">
                  <a href="#./images/home/menus/desert-big.jpg" class="boxer img-link"></a>
               </div>
               <!-- /.featured-img -->
         ...
         <div class="col-sm-6">
            <article class="menus-container wow fadeIn animated animated" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
               <div class="featured-img">
                  <img src="./images/home/dinner.jpg" alt="Dinner Menus Image">
                  <a href="#./images/home/menus/dinner-big.jpg" class="boxer img-link"></a>
               </div>
               <!-- /.featured-img -->
               <h4 class="item-title"> Dinner </h4>
               <div class="item-entry">
                  <p>
                     Layered with brandy, dry sherry and sweet onions, Ina Garten's soup staple is best soaked up with crusty bread. Take a delicious dinner now. 
                  </p>
               </div>
               <!-- /.item-entry -->
            </article>
...
<!-- Our Menus End -->
<!-- Book Table -->
<section id="book-table" class="parallax-style" style="background-position: 50% -250px;">
   <div class="book-table overlay-light section-padding">
      ...
      <div class="choose-table">
         <form action="#index.html#" method="post" class="choose-table-form">
...
<section id="events">
   <div class="events section-padding">
      ...
      <div class="event-container">
         <div class="row">
            <div class="col-sm-6">
               <div class="event-item wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                  <div class="event-img">
                     <img src="./images/home/event-1.jpg" alt="Event 1">
                  </div>
                  <!-- /.event-img -->
            ...
            <div class="col-sm-6">
               <div class="event-item wow fadeIn animated animated" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
                  <div class="event-img">
                     <img src="./images/home/event-2.jpg" alt="Event 1">
                  </div>
                  <!-- /.event-img -->
                  <div class="event-time">
                     <span class="event-month">September</span>
            ...
            <div class="col-sm-6">
               <div class="event-item wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                  <div class="event-img">
                     <img src="./images/home/event-3.jpg" alt="Event 1">
                  </div>
                  <!-- /.event-img -->
                  <div class="event-time">
                     <span class="event-month">September</span>
            ...
            <div class="col-sm-6">
               <div class="event-item wow fadeIn animated animated" data-wow-delay="0.2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
                  <div class="event-img">
                     <img src="./images/home/event-4.jpg" alt="Event 1">
                  </div>
                  <!-- /.event-img -->
                  <div class="event-time">
                     <span class="event-month">September</span>
...
<!-- Events End -->
<!-- Mobile App Section --> 
<section id="mobile-app" class="parallax-style" style="background-position: 50% -221px;">
   <div class="mobile-app overlay-normal section-padding">
      <div class="row">
         <div class="col-sm-5">
            <div class="mobile-container wow fadeIn animated animated" data-wow-delay="0.1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
               <img class="mobile-img" src="./images/home/mobile.png" alt="Mobile">
            </div>
            <!-- /.mobile-containe -->
         </div>
         <!-- /.col-sm-5 -->
         <div class="col-sm-7">
            ...
            <!-- /.apps-title -->
            <div class="btn-container">
               <a href="#index.html#" class="btn btn-sm btn-light-green">Download Now</a>
            </div>
            <!-- /.btn-container -->
         </div>
         <!-- /.col-sm-7 --> 
...
<section id="blog">
   <div class="blog-section section-padding">
      ...
      <div class="blog-post-container">
         <div class="row">
            <div class="col-sm-6">
               <article class="post-content wow fadeIn animated" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                  <div class="post-meta">
                  ...
                  <!-- /.post-meta -->
                  <div class="featured-img">
                     <img class="blog-post-image" src="./images/home/image-1.jpg" alt="Blog Post Image">
                     <a href="#./images/home/blog/big-image.jpg" class="boxer img-link"></a>
                  </div>
                  <!-- /.featured-img -->
            ...
            <!-- /.col-sm-6 -->
            <div class="col-sm-6">
               <article class="post-content wow fadeIn animated" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
                  <div class="post-meta">
                     <div class="entry-meta">
                        <div class="entry-date"> 
                  ...
                  <!-- /.post-meta -->
                  <div class="featured-img">
                     <img class="blog-post-image" src="./images/home/image-2.jpg" alt="Blog Post Image">
                     <a href="#./images/home/blog/big-image.jpg" class="boxer img-link"></a>
                  </div>
                  <!-- /.featured-img -->
                  <div class="post-container">
            ...
            <div class="col-sm-6">
               <article class="post-content wow fadeIn animated" data-wow-delay=".1s" style="visibility: visible; animation-delay: 0.1s; animation-name: fadeIn;">
                  ...
                  <!-- /.post-meta -->
                  <div class="featured-img">
                     <img class="blog-post-image" src="./images/home/image-3.jpg" alt="Blog Post Image">
                     <a href="#./images/home/blog/big-image.jpg" class="boxer img-link"></a>
                  </div>
                  <!-- /.featured-img -->
                  <div class="post-container">
            ...
            <div class="col-sm-6">
               <article class="post-content wow fadeIn animated" data-wow-delay=".2s" style="visibility: visible; animation-delay: 0.2s; animation-name: fadeIn;">
                  ...
                  <!-- /.post-meta -->
                  <div class="featured-img">
                     <img class="blog-post-image" src="./images/home/image-4.jpg" alt="Blog Post Image">
                     <a href="#./images/home/blog/big-image.jpg" class="boxer img-link"></a>
                  </div>
                  <!-- /.featured-img -->
                  <div class="post-container">
...
<!-- Testimonial Section -->
<section id="testimonial" class="parallax-style" style="background-position: 50% 122px;">
            ...
            <div class="item">
               <div class="testimonial-figure">
                  <div class="author-avatar">
                     <img class="img-circle" src="./images/home/01.png" alt="carousel image">
                  </div>
                  <!-- /.author-avatar --> 
                  <div class="authors-review">
                     ...
                     <div class="author-and-ulr">
                        ...
                        <a href="#index.html#" class="author-website">www.companyname.com</a> 
                     </div>
                     <!-- /.author-and-ulr --> 
                  </div>
                  <!-- /.authors-review --> 
...
<section id="our-crew">
   <div class="our-crew section-padding">
      ...
      <div class="crew-container">
         <div class="row">
            <div id="crew-slider" class="owl-carousel owl-theme" style="display: block; opacity: 1;">
               <div class="owl-wrapper-outer">
                  <div class="owl-wrapper" style="left: 0px; display: block; transition: all 1000ms ease; transform: translate3d(0px, 0px, 0px);">
                     <div class="owl-item" style="width: 33.33%;">
                        <div class="item col-xs-12">
                           <div class="crew-member-box wow fadeIn animated" data-wow-delay="0.1s" style="visibility: hidden; animation-delay: 0.1s; animation-name: none;">
                              ...
                              <div class="crew-photo">
                                 <img src="./images/home/01.jpg" alt="Crew Photo">
                              </div>
                              <!-- /.crew-photo -->
                           </div>
                           <!-- /.crew-member-box -->
                     ...
                     <div class="owl-item" style="width: 33.33%;">
                        <div class="item col-xs-12">
                           <div class="crew-member-box wow fadeIn animated" data-wow-delay="0.2s" style="visibility: hidden; animation-delay: 0.2s; animation-name: none;">
                              ...
                              <!--  /.about-crew -->
                              <div class="crew-photo">
                                 <img src="./images/home/02.jpg" alt="Crew Photo">
                              </div>
                              <!-- /.crew-photo -->
                           </div>
                           <!-- /.crew-member-box -->
                     ...
                     <div class="owl-item" style="width: 33.33%;">
                        <div class="item col-xs-12">
                           <div class="crew-member-box wow fadeIn animated" data-wow-delay="0.3s" style="visibility: hidden; animation-delay: 0.3s; animation-name: none;">
                              ...
                              <!--  /.about-crew -->
                              <div class="crew-photo">
                                 <img src="./images/home/03.jpg" alt="Crew Photo">
                              </div>
                              <!-- /.crew-photo -->
                           </div>
                           <!-- /.crew-member-box -->
...
<div id="tweet" class="parallax-style">
   <div class="tweet-section overlay-normal section-padding">
      ...
      <div id="tweet-slider" class="carousel slide tweet-slider" data-ride="carousel">
         ...
         <!-- /.carousel-inner -->
         <a class="slide-nav left" href="#index.html#tweet-slider" data-slide="prev"><i class="fa fa-chevron-left"></i></a>
         <a class="slide-nav right" href="#index.html#tweet-slider" data-slide="next"><i class="fa fa-chevron-right"></i></a>
      </div>
      <!-- /#tweet-slider -->  						
   </div>
   <!-- /.tweet-section -->
         ...
         <div class="row">
            <form action="#email.php" method="post" id="contact-form" class="wpcf7-form">
               ...
               <div class="col-sm-7 contact-form-elements">
                  <textarea name="your_message" id="your_message" cols="40" class="wpcf7-form-control wpcf7-textarea wpcf7-validates-as-required" placeholder="Your message here"></textarea>
...
<footer id="footer-section" class="main-container pull-right">
   ...
   <div class="copyrights "> 
      © <a href="#index.html#">Foody</a>  2015 - All Rights Reserved <span class="v-line"></span> Developed by <a href="https://jeweltheme.com/">Jewel Theme</a>
   </div>
   <!-- /.copyrights -->
</footer>
<!-- /#footer-section -->
